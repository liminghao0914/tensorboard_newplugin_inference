...
from tensorboard.plugins.new_func import plugin_data_pb2
from tensorboard.util import tb_logging

logger = tb_logging.get_logger()

PLUGIN_NAME = 'new_func'
...
def create_summary_metadata(display_name, description):
  ...
  """
  content = plugin_data_pb2.NewFuncPluginData(version=PROTO_VERSION)
...
def parse_plugin_metadata(content):
  ...
  result = plugin_data_pb2.NewFuncPluginData.FromString(content)
  if result.version == 0:
    return result
  else:
    logger.warn(
