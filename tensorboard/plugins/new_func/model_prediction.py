...
import numpy as np
from tensorboard.plugins.new_func.model import Network
from tensorboard.plugins.new_func.ReadTFRecord import read_and_decode
...
class Predict(object):
    ...
    def predict(self,file_path,batchsize_s):
        ...
        try:
            plt.savefig("/root/tensorboard/tensorboard/plugins/new_func/cache/cache_each_label_acc.png")
        except:
            print("dsd")
        os.system("python /root/tensorboard/tensorboard/plugins/new_func/refresh_board.py --log_dir /tmp/mnist")
'''
if __name__ == '__main__':
    model = Predict()
    model.predict('~/Desktop/data/mnist/test.tfrecords')
'''
